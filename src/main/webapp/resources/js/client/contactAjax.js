function sendContact()
{
	...
	$.ajax({
			...
			url: "http://localhost:8080/luxuryshop/createContact",
			success: function(result){
				alert("Cảm ơn quý khách đã liên hệ với chúng tôi. Luxury Shop sẽ phản hồi sớm cho các bạn");
				window.location.href = "/luxuryshop/contact";
			},
			error : function(e){
				alert("Error: ",e);
				console.log("Error" , e );
