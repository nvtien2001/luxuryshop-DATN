					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="form-group col-md-4">
									<label for="inputPassword4">Kích thước</label> <input
										type="text" class="form-control" name="kichThuoc">
								</div>

								<div class="form-group col-md-4">
									<label for="inputEmail4">Chất liệu</label> <input type="text"
										class="form-control" name="chatLieu" required="required">
								</div>
							...
							<div class="row">
								...
								<div class="form-group col-md-4">
									<label for="inputPassword4">Đơn vị tính</label> <input type="text"
										class="form-control" name="dvt" required="required">
								</div>
								<div class="form-group col-md-4">
									<label for="inputEmail4">Kiểu dáng</label> <input type="text"
										class="form-control" name="kieuDang">
								</div>
								<div class="form-group col-md-4">
									<label for="inputPassword4">Phong cách</label> <input type="text"
										class="form-control" name="phongCach">
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-md-4">
									<label for="inputEmail4">Hoàn thiện</label> <input
										type="text" class="form-control" name="hoanThien"
										required="required">
								</div>
								<div class="form-group col-md-4">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Chất liệu</label> <input
										type="text" class="form-control" name="chatLieu">
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Đơn vị tính</label> <input
										type="text" class="form-control"
										name="dvt">
								</div>
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Phong cách</label> <input
										type="text" class="form-control"
										name="phongCach">
								</div>

								<div class="form-group col-md-6">
									<label for="inputPassword4">Hoàn thiện</label> <input
										type="text" class="form-control" name="hoanThien">
								</div>
							</div>
							<div>
