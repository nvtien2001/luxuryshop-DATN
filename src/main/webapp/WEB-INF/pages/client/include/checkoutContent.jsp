...
<div class="container">
	...
	<br><br>
		...
		<div class="col-md-3">
			...
			<p style="line-height:2;" >Họ tên người nhận hàng <b style="color: red">*</b></p>
			<input size="27" name="hoTenNguoiNhan" required>
			
			<p style="line-height:2;">Số điện thoại <b style="color: red">*</b></p>
			<input size="27" name="sdtNhanHang" required>
			
			
			<p style="line-height:2;">Địa chỉ(số nhà, đường, tỉnh thành) <b style="color: red">*</b></p>
