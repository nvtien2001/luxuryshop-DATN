		...
		<div class="header-top-nav ">
			<c:if test="${pageContext.request.userPrincipal.name != null}">
				...
				<ul>
					...
					<li><a href="<%=request.getContextPath()%>/cart"><span>Giỏ hàng&nbsp;&nbsp;: </span></a>
						<span class="glyphicon glyphicon-shopping-cart"></span></li>
...
<div class="top-header">
	<div class="wrap">
		<!----start-logo---->
		<div class="logo">
			<a href="<%=request.getContextPath()%>/" style="font-size: 28px;color: white; text-decoration: none;">
				LUXURY SHOP
			</a>
		</div>
		<!----end-logo---->
		...
		<div class="top-nav">
			<ul>
				...
				<li><a href="<%=request.getContextPath()%>/guarantee">Bảo hành tận nơi</a></li>
