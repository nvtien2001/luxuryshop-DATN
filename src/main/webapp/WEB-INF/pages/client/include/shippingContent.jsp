...
<div class ="container">
	<div class="row">
		...
		<div class="col-md-10" class="pull-center">
			...
			<h3>- Những rủi ro phát sinh trong quá trình vận chuyển (va đập, ẩm ướt, tai nạn..) có thể ảnh hưởng đến hàng hóa, vì thế xin Quý Khách vui lòng kiểm tra hàng hóa thật kỹ trước khi ký nhận. Shop sẽ không chịu trách nhiệm với những sai lệch hình thức của hàng hoá sau khi Quý khách đã ký nhận hàng.</h3>
			<br>
			...
			<table class="table-cart-checkout mytable">
					...
					<tr style="text-align: center;">
						    ...
						    <td>35km</td>
						    <td>Giao hàng trong vòng 4h. <br> Giao hàng trong 24h (36km-45km) </td>
			...
			<br>
			<p>
- Đối với khách hàng vượt quá khoảng cách quy định từ 46km trở lên, áp dụng phương thức gửi xe khách (khách hàng chọn xe để gửi) hoặc chuyển phát nhanh, khách hàng thanh toán phí vận chuyển cho bên giao hàng.
			</p>
