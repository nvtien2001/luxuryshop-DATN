...
<head>
<meta charset="UTF-8">
<title>Luxury Shop - Đăng ký</title>
...
<body>
	...
	<div class="login-page">
		<div class="form">
			<form:form method="POST" action='register' modelAttribute="newUser">
				<h2 class="form-signin-heading" style="text-align: center">LuxuryShop - Đăng ký tài khoản</h2>
				<hr/>
				<div class="form-group">
				...
				<p class="message" style="font-size: 18px; padding-top:10px"> Đã có tài khoản? <a href="<c:url value='/login'/> ">Đăng nhập</a></p>
			</form:form>
		</div>
	</div>
	<script
