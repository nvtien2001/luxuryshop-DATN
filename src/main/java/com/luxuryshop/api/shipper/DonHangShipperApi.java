package com.luxuryshop.api.shipper;
...
import com.luxuryshop.dto.CapNhatDonHangShipper;
import com.luxuryshop.dto.SearchDonHangObject;
...
public class DonHangShipperApi {
	...
	public Page<DonHang> getDonHangByFilter(@RequestParam(defaultValue = "1") int page, @RequestParam String trangThai,
		...
		return donHangService.findDonHangByShipper(object, page, 6, shipper);
	}
